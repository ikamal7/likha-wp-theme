...
// -------------------------------------------------------------------------- //
    $(document).ready(function(){
        ...
        $(".comment-reply-link").addClass("btn link-btn btn-rounded");
        ...
        //console.log(imgurl);
        //$("nav.navbar.bootsnav ul ul").parent("li").children("a").addClass("dropdown-toggle");
        $("nav.navbar.bootsnav").find("ul.sub-menu").parent("li").children("a").append("<i class='fa fa-chevron-down'></i>");
    });
